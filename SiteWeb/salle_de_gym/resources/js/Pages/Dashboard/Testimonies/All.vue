        ...
        <div class="max-w-7xl mx-auto px-6">
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div v-for="testimonie in testimonies.data" :key="testimonie.id" class="relative bg-white rounded-2xl p-5 hover:shadow-xl transition">
                        ...
                        <div class="mt-4 space-y-2 text-sm">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span>{{ truncate(testimonie.opinion, 40) }}</span>
                            </div>
                        </div>
            ...
            <div class="flex justify-end gap-1 mt-6 pt-4 border-t border-gray-400">
                <Link
                    v-for="(link, index) in testimonies.links"
                    :key="index"
                    :href="link.url ?? '#'"
                    v-html="link.label"
                    :class="[

        ...
        <header class="relative">
            ...
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                ...
                <p class="capitalize text-white font-semibold text-md md:text-xl mt-2">
                    <a :href="route('home')" class="hover:text-gray-300">home</a><i class="bi bi-chevron-right text-[10px] md:text-[12px] px-1"></i><span class="text-amber-500 text-md md:text-xl">bmi</span>
                </p>
            </div>
        </header>

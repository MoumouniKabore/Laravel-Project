...
class UpdateTeamRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => [
                ...
                'string',
                'max:30',
                Rule::unique('teams', 'phone')->ignore($this->route('team')),
            ],
            ...
            'email' => [
                ...
                'email',
                'max:255',
                Rule::unique('teams', 'email')->ignore($this->route('team')),
            ],
    ...
    public function messages(): array {
        return [
            ...
            'phone.integer'      => 'Vous devez entrer des chiffre',
            ...
            'address.min'        => 'L\'adresse doit avoir au moins 2 caractères',
            'address.max'        => 'L\'adresse e doit pas dépasser les 50 caractères',
